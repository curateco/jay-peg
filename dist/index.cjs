...
class $0b53e5b7c7fe341c$var$IDFEntries {
    ...
    _getTagValue(dataValue, dataFormat) {
        ...
        switch(dataFormat){
            case 1:
                return (0, $bd10db122e664297$export$a91b4a1eede2f230)(dataValue, 0);
            case 2:
    ...
    decode(stream, parent) {
        ...
        if (exifIFDPointer) {
            ...
            entries.subExif = this._decodeIDFEntries(buffer, $0b53e5b7c7fe341c$var$tags.ifd, exifIFDPointer);
        }
